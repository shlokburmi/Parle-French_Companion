...
### 📸 Scan & Learn (Tesseract-Powered OCR)
* **Real-world Capture**: Drop or upload images of French text (labels, articles, restaurant menus, book pages).
* **Instant Word Extraction**: The app runs client-side OCR to isolate vocabulary, letting you choose exactly which words you want to study.
* **Seamless Transition**: Kickstart an AI conversation using the scanned words instantly.

### 💬 Dynamic AI Conversations
* **Active Practice**: The application generates tailored sentences containing your vocabulary, prompting you to respond in French.
* **Audio & Speech Sync**: Listen to correct pronunciations spoken in native French, then reply using either the keyboard or your microphone.

### 📖 Vocabulary Pokédex
* **Interactive Portfolio**: A growing repository of all the words you've scanned and learned.
* **Grammar Classification**: View parts of speech categorized dynamically (nouns, verbs, adjectives, etc.) with custom color-coded badges.
* **Usage & Pronunciation**: Play native audio examples of each word in a complete sentence to understand its syntax.
* **Vocabulary Challenges**: Test yourself with dynamic, AI-generated multiple-choice quizzes designed specifically for your vocabulary bank.

### 🎧 Immersion Audio Storylines
* **Graded Listening**: Choose from hand-crafted dialogues tailored for different levels of the Common European Framework of Reference for Languages (CEFR) – from A1 (Cafe) up to B2 (Job Interview).
* **Variable Playback Speed**: Slow down the audio to 0.8x or speed it up to 1.2x to test your comprehension.
* **Repeat-After-Me Mode**: Select individual lines of dialogue to record yourself, getting an instant pronunciation match score.

### 🤖 Scenario-Based AI Tutor
* **Interactive Roleplay**: Step into authentic scenarios, such as ordering at a café, checking into a boutique hotel, planning a French vacation, or interviewing for a professional role.
* **Tutor Tips**: Get qualitative feedback, spelling warnings, and actionable advice to improve your fluency.
* **Score Ring Visualizations**: View your progress across four dimensions: **Fluency**, **Vocabulary**, **Grammar**, and **Speech Accuracy**.

### 📊 Fluency Progress Dashboard
* **Milestone Tracking**: View your daily learning streak to stay motivated.
* **Session Archiving**: Review a chronological timeline of all your past conversations. Expand any session to look at round-by-round logs, see what you said, and re-read your tutor's custom feedback.
